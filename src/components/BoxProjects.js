    ...
    return (
        ...
        >
            ...
            <p className='project'>
                ...
                <a href='https://portfolio.bbbaden.ch/view/view.php?t=e15PZfdOlrnyR76V4bkN' className='link' target="_blank">
                    Portfolios Mahara</a>
            </p>
            <p className='project'>
                Meine Projekte, wie diese Website, können Sie auf GitHub finden: <br />
                <a href='https://github.com/marianives?tab=repositories' className='link' target="_blank">GitHub Profile</a>
            </p>
            ...
            <p className='project'>
                ...
                <a href='https://open.hpi.de/courses?q=&channel=&lang=&topic=Programming&level=' className='link' target="_blank">Online Selbstlernkurse</a>
            </p>
        </BoxProjects>
